...
class SessionStore: ObservableObject {
    ...
    func postPetImages(imagesData: [Data], petType: String, petName: String, petRace: String, petAge: String, petSize: String, suitables: String, petGender: String, description: String, phoneNumber: String, city: String, goodWords: String, vaccinated: String, poopTrained: String) {
            ...
            storage.child(fileName).putData(i, metadata: metaData, completion: { result, error in
                ...
                self.storage.child(fileName).downloadURL(completion: { url, error in
                    ...
                    if self.imagePaths.count == imagesData.count {
                        ...
                        self.postNewPet(petType: petType, petName: petName, petRace: petRace, petAge: petAge, petSize: petSize, suitables: suitables, petGender: petGender, description: description, phoneNumber: phoneNumber, city: city, goodWords: goodWords, vaccinated: vaccinated, poopTrained: poopTrained, images: sortedImagePaths )
                        self.waitingForResponse = false
